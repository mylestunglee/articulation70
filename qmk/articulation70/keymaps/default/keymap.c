...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_NUMPAD] = LAYOUT_split(
        ...
        _______ , _______ , _______ , _______ , _______ , _______           ,           KC_NO   , KC_P1   , KC_P2   , KC_P3   , KC_P0   , KC_LALT           , _______ ,
        _______ , _______ ,                     _______ , _______ , _______ , _______ , _______ , _______                     , KC_PDOT , UK_BSLS , _______ , _______ , _______
    ),
    ...
    [LAYER_UPPER] = LAYOUT_split(
        KC_VOLD , KC_VOLU , UK_TILD , UK_AT   , KC_COLN , KC_NO             ,           KC_NUM  , KC_7    , KC_8    , KC_9    , KC_MINS , KC_TGNU , _______ , _______ , _______ ,
        _______ , UK_NOT  , KC_LBRC , KC_RBRC , KC_UNDS , KC_NO             ,           KC_CAPS , KC_4    , KC_5    , KC_6    , KC_PLUS , KC_PENT , _______ , _______ , _______ ,
        _______ , KC_PLUS , KC_LCBR , KC_RCBR , KC_NO   , KC_NO             ,           KC_SCRL , KC_1    , KC_2    , KC_3    , KC_0    , _______           , _______ ,
